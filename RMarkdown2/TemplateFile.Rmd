...
<!-- 
TemplateFile.tex version 0.20 (11/2024), Maria Valaste
...
# add your list of packages here inside of p_load() function. This list is an examples only.
if (!require("pacman")) install.packages("pacman") 
pacman::p_load(tidyverse, kable, haven, janitor, psych, lm.beta, broom, knitr)
```
